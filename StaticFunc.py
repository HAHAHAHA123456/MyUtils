...
def staticLottery_staticVariableNumber(dataList):
    staticInfo_dict = {}
    for i in range(0, 6):
        tempDict = {}
        countsNumber, maxContinous, maxLeaveNumber = staticCounts_Continous_leaveOut(dataList=dataList, number=i)
...
def staticLotteryTailNumberWithInfo(dataList, continousInfo, leaveOutInfo):
    staticInfo_dict = {}
    for i in range(0, 10):
        tempDict = {}
        countsNumber, maxContinous, maxLeaveNumber = staticCounts_Continous_leaveOutFindMax(dataList=dataList, continousInfo = continousInfo, leaveOutInfo = leaveOutInfo, number=i)
...
def staticLotteryRemainderNumberWithInfo(dataList, continousInfo, leaveOutInfo):
    staticInfo_dict = {}
    for i in range(0, 3):
        tempDict = {}
        countsNumber, maxContinous, maxLeaveNumber = staticCounts_Continous_leaveOutFindMax(dataList=dataList, continousInfo = continousInfo, leaveOutInfo = leaveOutInfo, number=i)
...
def staticCounts_Continous_leaveOutFindMax(dataList, continousInfo, leaveOutInfo, number):
    ...
    while idx < len(dataList):
        ...
        if idx != len(dataList) - 1:
            if continousInfo[idx][number] > maxContinous:
                maxContinous = continousInfo[idx][number]
            if leaveOutInfo[idx][number] > maxLeaveNumber:
                maxLeaveNumber = leaveOutInfo[idx][number]
        idx += 1
    return countsNumber, maxContinous, maxLeaveNumber
